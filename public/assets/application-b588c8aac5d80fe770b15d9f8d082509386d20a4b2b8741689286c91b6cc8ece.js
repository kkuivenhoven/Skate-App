...
function firebaseSignInUser(){
	firebase.auth().signInWithEmailAndPassword(document.getElementById("loginLink").children[1].value, document.getElementById("loginLink").children[3].value).catch(function(error){
		var errorCode = error.code;
		var errorMessage = error.message;
		console.log(errorCode);
		console.log(errorMessage);
