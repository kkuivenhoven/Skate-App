...
//alert($(chatboxtextarea)[0].scrollHeight);
...
//alert("message != ''");
            ...
            //var adjustedHeight = $(chatboxtextarea)[0].scrollHeight;
            var adjustedHeight = $(chatboxtextarea)[0].clientHeight;
            var maxHeight = 94;

            if (maxHeight > adjustedHeight) {
                //adjustedHeight = Math.max(chatboxtextarea.scrollHeight, adjustedHeight);
                adjustedHeight = Math.max($(chatboxtextarea)[0].scrollHeight, adjustedHeight);
                if (maxHeight){
//alert("maxHeight here: " + maxHeight);
                    adjustedHeight = Math.min(maxHeight, adjustedHeight);
										//alert("adjustedHeight: " + adjustedHeight);
								}
                //if (adjustedHeight > chatboxtextarea.clientHeight){
                if (adjustedHeight > $(chatboxtextarea)[0].clientHeight){
//alert("adjustedHeight > chatboxtextarea.clientHeight");
...
$(document).ready(ready);
$(document).on('page:ready', ready);
//$(document).on('page:load', oready);
//$(document).on("turbolinks:load", oready);
//$(document).on('page:change', ready);
(function() {
