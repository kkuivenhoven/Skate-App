...
/*$(document).ready(function(){
	$(function(){
		$('[data-toggle="popover"]').popover({
			html: true,
			template: '<div class="popover navPopover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div><div class="popover-footer"><a href="#" class="btn btn-info btn-sm">Close</a></div></div>'
		});
	});
...
function firebaseSignInUser(){
	firebase.auth().signInWithEmailAndPassword(document.getElementById("loginLink").children[3].value, document.getElementById("loginLink").children[6].value).catch(function(error){
		var errorCode = error.code;
		var errorMessage = error.message;
		console.log(errorCode);
		console.log(errorMessage);
...
function firebaseUpdateEmail(){
	var user = firebase.auth().currentUser;

	user.updateEmail(document.getElementById("settingsLink").children[7].value).catch(function(error){
		var errorCode = error.code;
		var errorMessage = error.message;
		console.log(errorCode);
		console.log(errorMessage);
